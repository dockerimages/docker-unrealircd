...
## Install anope
cd /tmp
wget -O anope-$ANOPE_VERSION.tar.gz http://sourceforge.net/projects/anope/files/anope-stable/Anope%20$ANOPE_VERSION/anope-$ANOPE_VERSION-source.tar.gz/download 
